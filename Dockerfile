...
COPY ./src/ubuntu/install/dind/portainer.sh $STARTUPDIR/portainer.sh
RUN chmod 755 $STARTUPDIR/portainer.sh
COPY ./src/ubuntu/install/dind/portainer.conf /etc/supervisor/conf.d/
